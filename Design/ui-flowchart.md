...
flowchart TD
    ...
    OTPInputScreen --> EmailLoginSuccess[Screen: Welcome Back, usernickname or username]
    ...
    GoogleAuthScreen -->|Existing User| GoogleLoginSuccess[Screen: Welcome Back, usernickname or username ]
    ...
    GitHubAuthScreen -->|Existing User| GitHubLoginSuccess[Screen: Welcome Back, usernickname or username]
